...
node {
        ...
        */
        ...
        def testApp = openshift.newApp("s2i-nodejs:${tag}~https://github.com/ausnimbus/node-ex", "-l app=node-ex");
        ...
        openshift.tag("ausnimbus-ci/s2i-nodejs:${tag}", "ausnimbus-staging/s2i-nodejs:${tag}")
}
